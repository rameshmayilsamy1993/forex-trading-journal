...
export default function WeeklyReviewCard({ review, onOpen, onEdit, onDelete }: ReviewCardProps) {
  const weekStart = format(new Date(review.weekStart), 'MMM d');
  const weekEnd = format(new Date(review.weekEnd), 'MMM d, yyyy');
      ...
      <div className="flex gap-5 p-5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5 text-caption text-[#64748B] mb-3">
            ...
            Week {review.weekNumber} ({weekStart} — {weekEnd})
          </div>
