...
export default function MissedTradeJournal() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      {/* Page Header */}
      <div className="bg-white rounded-[20px] shadow-[0_10px_30px_rgba(0,0,0,0.06)] border border-[#E5E7EB] p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-page-title font-bold text-[#0F172A]">CRT Missed Trade Journal</h2>
            <p className="text-body text-[#64748B] mt-1">Track ICT/CRT missed trading opportunities with Turtle Soup timing</p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
          <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-[20px] shadow-[0_10px_30px_rgba(0,0,0,0.06)] border border-[#E5E7EB] p-5 transition-all duration-200 hover:shadow-[0_14px_40px_rgba(0,0,0,0.1)] hover:-translate-y-0.5">
          ...
          <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-[20px] shadow-[0_10px_30px_rgba(0,0,0,0.06)] border border-[#E5E7EB] p-5 transition-all duration-200 hover:shadow-[0_14px_40px_rgba(0,0,0,0.1)] hover:-translate-y-0.5">
          ...
          <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-[20px] shadow-[0_10px_30px_rgba(0,0,0,0.06)] border border-[#E5E7EB] p-5 transition-all duration-200 hover:shadow-[0_14px_40px_rgba(0,0,0,0.1)] hover:-translate-y-0.5">
          ...
          <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-[20px] shadow-[0_10px_30px_rgba(0,0,0,0.06)] border border-[#E5E7EB] p-5 transition-all duration-200 hover:shadow-[0_14px_40px_rgba(0,0,0,0.1)] hover:-translate-y-0.5">
            <p className="text-caption text-slate-600 uppercase">Most Missed Pair</p>
            <p className="text-page-title font-bold text-slate-800 mt-1">{stats.mostMissedPair || '-'}</p>
          </div>
        </div>
      </div>

      {/* Filters Card */}
      <div className="bg-white rounded-[20px] shadow-[0_10px_30px_rgba(0,0,0,0.06)] border border-[#E5E7EB] p-5">
      ...
      {(isAdding || editingId) && (
        <div className="bg-white rounded-[20px] shadow-[0_10px_30px_rgba(0,0,0,0.06)] border border-[#E5E7EB] p-6">
          <h3 className="font-bold text-card-title text-[#0F172A] mb-6 flex items-center gap-2">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#F8FAFC] rounded-xl p-4 border border-[#E5E7EB]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">Pair *</label>
                ...
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">Type *</label>
                ...
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">Entry Price *</label>
                  <Input
                    type="number"
                    step="0.00001"
                    placeholder="1.0850"
                ...
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">Stop Loss *</label>
                  <Input
                    type="number"
                    step="0.00001"
                    placeholder="1.0820"
                ...
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">Take Profit *</label>
                  <Input
                    type="number"
                    step="0.00001"
                    placeholder="1.0950"
                ...
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">RR Ratio</label>
                  <div className="h-12 px-3 flex items-center bg-[#F8FAFC] rounded-xl border border-[#E5E7EB]">
            ...
            <div className="bg-[#F8FAFC] rounded-xl p-4 border border-[#E5E7EB]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">Date *</label>
                  <Input
                    type="date"
                    className="bg-white border-[#E5E7EB]"
                    value={formData.date}
                ...
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">Entry Time</label>
                  <TimePicker
                    value={formData.time}
                ...
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">Turtle Soup Date</label>
                  <Input
                    type="date"
                    className="bg-white border-[#E5E7EB]"
                ...
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">Turtle Soup Time</label>
                  <TimePicker
                ...
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">Daily Quarter</label>
                ...
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">6HR Quarter</label>
            ...
            <div className="bg-[#F8FAFC] rounded-xl p-4 border border-[#E5E7EB]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">Profit/Loss</label>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">$</span>
                    <Input type="number" step="0.01" placeholder="0.00" className="pl-7 bg-white border-[#E5E7EB]" value={formData.profitLoss} onChange={(e) => setFormData({ ...formData, profitLoss: e.target.value })} />
                  </div>
                </div>
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">Commission</label>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">$</span>
                    <Input type="number" step="0.01" placeholder="0.00" className="pl-7 bg-white border-[#E5E7EB]" value={formData.commission} onChange={(e) => setFormData({ ...formData, commission: e.target.value })} />
                  </div>
                </div>
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">Swap</label>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">$</span>
                    <Input type="number" step="0.01" placeholder="0.00" className="pl-7 bg-white border-[#E5E7EB]" value={formData.swap} onChange={(e) => setFormData({ ...formData, swap: e.target.value })} />
                  </div>
                </div>
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">Real P/L</label>
                  <div className={`h-12 px-3 flex items-center bg-[#F8FAFC] rounded-xl border border-[#E5E7EB] font-semibold ${calculatedRealPL >= 0 ? 'text-[#10B981]' : 'text-[#EF4444]'}`}>
            ...
            <div className="bg-[#F8FAFC] rounded-xl p-4 border border-[#E5E7EB]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">Model #1 Confirmation</label>
                ...
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">SSMT Confirmation</label>
            ...
            <div className="bg-[#F8FAFC] rounded-xl p-4 border border-[#E5E7EB]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">Reason Missed *</label>
                ...
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">Status</label>
                ...
                <div>
                  <label className="block text-body-sm text-slate-600 mb-1">Emotion</label>
                  <Input placeholder="Optional" className="bg-white border-[#E5E7EB]" value={formData.emotion} onChange={(e) => setFormData({ ...formData, emotion: e.target.value })} />
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#F8FAFC] rounded-xl p-4 border border-[#E5E7EB]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="block text-body-sm text-slate-600 mb-2">Before Screenshot</label>
                  <div className="modern-file-upload group relative border-2 border-dashed border-[#E5E7EB] rounded-lg p-4 hover:border-[#7C3AED] transition-colors">
                    ...
                    <div className="flex flex-col items-center justify-center space-y-2">
                      {uploadingImage === 'before' ? (
                        ...
                        <>
                          ...
                          <span className="text-caption text-slate-500">Click to upload</span>
                        </>
                      )}
                    </div>
                  </div>
                  {formData.screenshots.before && (
                    <div className="relative mt-2 inline-block">
                      <img src={formData.screenshots.before} alt="Before" className="h-16 rounded object-cover border border-[#E5E7EB]" />
                ...
                <div>
                  <label className="block text-body-sm text-slate-600 mb-2">After Screenshot</label>
                  <div className="modern-file-upload group relative border-2 border-dashed border-[#E5E7EB] rounded-lg p-4 hover:border-[#7C3AED] transition-colors">
                  ...
                  {formData.screenshots.after && (
                    <div className="relative mt-2 inline-block">
                      <img src={formData.screenshots.after} alt="After" className="h-16 rounded object-cover border border-[#E5E7EB]" />
                ...
                <div>
                  <label className="block text-body-sm text-slate-600 mb-2">Notes</label>
                  <textarea
                    placeholder="Add notes about why this trade was missed..."
                    className="w-full h-28 p-3 bg-white border border-[#E5E7EB] rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-[#7C3AED]/20 text-body"
          ...
          {/* Action Buttons */}
          <div className="flex gap-3 justify-end mt-6 pt-4 border-t border-[#E5E7EB]">
            <button onClick={() => { setIsAdding(false); setEditingId(null); resetForm(); }} className="inline-flex items-center gap-2 px-5 py-2.5 bg-slate-200 text-slate-700 text-button rounded-xl hover:bg-slate-300 transition-all duration-200">
              <X className="w-4 h-4" />
              Cancel
            </button>
      ...
      {filteredMissedTrades.length === 0 && !isAdding && (
        <div className="bg-white rounded-[20px] shadow-[0_10px_30px_rgba(0,0,0,0.06)] border border-[#E5E7EB] p-12 text-center">
      ...
      {filteredMissedTrades.length > 0 && (
        <div className="bg-white rounded-[20px] shadow-[0_10px_30px_rgba(0,0,0,0.06)] border border-[#E5E7EB] overflow-hidden transition-all duration-200 hover:shadow-[0_14px_40px_rgba(0,0,0,0.1)] hover:-translate-y-0.5">
                ...
                {filteredMissedTrades.map(trade => {
                  ...
                  return (
                    <tr key={trade.id} className="border-b border-[#E5E7EB] hover:bg-[#F8FAFC] transition-colors duration-150">
                      ...
                      <td className="py-3.5 px-4 whitespace-nowrap">
                        <span className="inline-flex items-center px-2.5 py-1 rounded-full text-caption font-bold bg-[#F8FAFC] text-[#0F172A] ring-1 ring-[#E5E7EB]">
                          {trade.pair}
                        </span>
                      </td>
                      <td className="py-3.5 px-4 whitespace-nowrap">
      ...
      {viewingTrade && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-in fade-in duration-200" onClick={() => setViewingTrade(null)}>
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col" onClick={(e) => e.stopPropagation()}>
            <div className="p-5 border-b border-[#E5E7EB] bg-gradient-to-r from-violet-50/40 to-white flex-shrink-0">
              <div className="flex items-start justify-between">
                <div>
                  <div className="flex items-center gap-3">
                    <h2 className="text-section-title font-bold text-[#0F172A]">CRT Missed Trade</h2>
                    ...
                    <span className="text-body-sm text-slate-500">{viewingTrade.pair}</span>
                  </div>
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-4">
              ...
              <div className="bg-[#F8FAFC] rounded-xl p-4">
                <h4 className="text-body-sm text-[#0F172A] mb-3 flex items-center gap-2">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="bg-white rounded-lg p-3 border border-[#E5E7EB]">
                    <p className="text-caption text-slate-500">Pair</p>
                    <p className="text-body-sm text-[#0F172A] mt-0.5">{viewingTrade.pair}</p>
                  </div>
                  <div className="bg-white rounded-lg p-3 border border-[#E5E7EB]">
                  ...
                  <div className="bg-white rounded-lg p-3 border border-[#E5E7EB]">
                    <p className="text-caption text-slate-500">Entry</p>
                    <p className="text-body-sm text-[#0F172A] mt-0.5 font-mono">{formatPrice(viewingTrade.entryPrice, viewingTrade.pair)}</p>
                  </div>
                  <div className="bg-white rounded-lg p-3 border border-[#E5E7EB]">
                    <p className="text-caption text-slate-500">Stop Loss</p>
                    <p className="text-body-sm text-[#EF4444] mt-0.5 font-mono">{formatPrice(viewingTrade.stopLoss, viewingTrade.pair)}</p>
                  </div>
                  <div className="bg-white rounded-lg p-3 border border-[#E5E7EB]">
                    <p className="text-caption text-slate-500">Take Profit</p>
                    <p className="text-body-sm text-[#10B981] mt-0.5 font-mono">{formatPrice(viewingTrade.takeProfit, viewingTrade.pair)}</p>
                  </div>
                  <div className="bg-white rounded-lg p-3 border border-[#E5E7EB]">
                    <p className="text-caption text-slate-500">Real P/L</p>
              ...
              <div className="bg-[#F8FAFC] rounded-xl p-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white rounded-lg p-3 border border-[#E5E7EB]">
                    <p className="text-caption text-slate-500">Entry Time</p>
                    <div className="mt-1"><EntryTimeBadge time={viewingTrade.time} /></div>
                  </div>
                  <div className="bg-white rounded-lg p-3 border border-[#E5E7EB]">
                    <p className="text-caption text-slate-500">Turtle Soup High Time</p>
                    <div className="mt-1"><TurtleSoupBadge time={viewingTrade.turtleSoupTime} /></div>
                  </div>
                  <div className="bg-white rounded-lg p-3 border border-[#E5E7EB]">
                    <p className="text-caption text-slate-500">Daily Quarter</p>
                    <div className="mt-1"><QuarterBadge quarter={viewingTrade.dailyQuarter} /></div>
                  </div>
                  <div className="bg-white rounded-lg p-3 border border-[#E5E7EB]">
                    <p className="text-caption text-slate-500">6HR Quarter</p>
              ...
              <div className="bg-[#F8FAFC] rounded-xl p-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white rounded-lg p-3 border border-[#E5E7EB]">
                    <p className="text-caption text-slate-500 mb-1">Model #1</p>
              ...
              <div className="bg-[#F8FAFC] rounded-xl p-4">
                ...
                <div className="space-y-3">
                  <div className="bg-white rounded-lg p-3 border border-[#E5E7EB]">
                    <p className="text-caption text-slate-500 mb-1">Reason Missed</p>
                    <p className="text-body text-[#0F172A]">{viewingTrade.reason || viewingTrade.missedReason || '-'}</p>
                  </div>
                  {(viewingTrade as any).notes && (
                    <div className="bg-white rounded-lg p-3 border border-[#E5E7EB]">
                      <p className="text-caption text-slate-500 mb-1">Notes</p>
                      <p className="text-body text-[#0F172A]">{(viewingTrade as any).notes}</p>
                    </div>
                  )}
                  {(viewingTrade.screenshots?.before || viewingTrade.screenshots?.after) && (
                    <div className="bg-white rounded-lg p-3 border border-[#E5E7EB]">
                      <p className="text-caption text-slate-500 mb-2">Screenshots</p>
      ...
      {viewingReason && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50" onClick={() => setViewingReason(null)}>
          <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full max-h-[80vh] overflow-hidden animate-in zoom-in-95 duration-200" onClick={(e) => e.stopPropagation()}>
            <div className="p-5 border-b border-[#E5E7EB] bg-gradient-to-r from-violet-50 to-indigo-50/50">
              <div className="flex items-center justify-between">
                <h3 className="text-card-title font-bold text-[#0F172A]">{viewingReason.title}</h3>
