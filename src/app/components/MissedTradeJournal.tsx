...
export default function MissedTradeJournal() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      {/* Page Header */}
      <div className="bg-white/[0.04] rounded-[20px] shadow-md shadow-black/20 border border-white/10 p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
          <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-[20px] shadow-md shadow-black/20 border border-white/10 p-5 transition-all duration-200 hover:shadow-[0_14px_40px_rgba(0,0,0,0.1)] hover:-translate-y-0.5">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-[20px] shadow-md shadow-black/20 border border-white/10 p-5 transition-all duration-200 hover:shadow-[0_14px_40px_rgba(0,0,0,0.1)] hover:-translate-y-0.5">
          ...
          <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-[20px] shadow-md shadow-black/20 border border-white/10 p-5 transition-all duration-200 hover:shadow-[0_14px_40px_rgba(0,0,0,0.1)] hover:-translate-y-0.5">
          ...
          <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-[20px] shadow-md shadow-black/20 border border-white/10 p-5 transition-all duration-200 hover:shadow-[0_14px_40px_rgba(0,0,0,0.1)] hover:-translate-y-0.5">
          ...
          <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-[20px] shadow-md shadow-black/20 border border-white/10 p-5 transition-all duration-200 hover:shadow-[0_14px_40px_rgba(0,0,0,0.1)] hover:-translate-y-0.5">
          ...
          <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-[20px] shadow-md shadow-black/20 border border-white/10 p-5 transition-all duration-200 hover:shadow-[0_14px_40px_rgba(0,0,0,0.1)] hover:-translate-y-0.5">
      ...
      {/* Filters Card */}
      <div className="bg-white/[0.04] rounded-[20px] shadow-md shadow-black/20 border border-white/10 p-5">
            ...
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <div className="h-12 px-3 flex items-center bg-white/5 rounded-xl border border-white/10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input type="number" step="0.01" placeholder="0.00" className="pl-7 bg-white/[0.04] border-white/10" value={formData.profitLoss} onChange={(e) => setFormData({ ...formData, profitLoss: e.target.value })} />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">$</span>
                    <Input type="number" step="0.01" placeholder="0.00" className="pl-7 bg-white/[0.04] border-white/10" value={formData.commission} onChange={(e) => setFormData({ ...formData, commission: e.target.value })} />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">$</span>
                    <Input type="number" step="0.01" placeholder="0.00" className="pl-7 bg-white/[0.04] border-white/10" value={formData.swap} onChange={(e) => setFormData({ ...formData, swap: e.target.value })} />
                  </div>
                </div>
                <div>
                  <label className="block text-body-sm text-muted-foreground mb-1">Real P/L</label>
                  <div className={`h-12 px-3 flex items-center bg-white/5 rounded-xl border border-white/10 font-semibold ${calculatedRealPL >= 0 ? 'text-[#10B981]' : 'text-[#EF4444]'}`}>
            ...
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <Input placeholder="Optional" className="bg-white/[0.04] border-white/10" value={formData.emotion} onChange={(e) => setFormData({ ...formData, emotion: e.target.value })} />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <div className="modern-file-upload group relative border-2 border-dashed border-white/10 rounded-lg p-4 hover:border-[#7C3AED] transition-colors">
                  ...
                  {formData.screenshots.before && (
                    <div className="relative mt-2 inline-block">
                      <img src={formData.screenshots.before} alt="Before" className="h-16 rounded object-cover border border-white/10" />
                ...
                <div>
                  ...
                  {formData.screenshots.after && (
                    <div className="relative mt-2 inline-block">
                      <img src={formData.screenshots.after} alt="After" className="h-16 rounded object-cover border border-white/10" />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full h-28 p-3 bg-white/[0.04] border border-white/10 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-[#7C3AED]/20 text-body"
      ...
      {filteredMissedTrades.length === 0 && !isAdding && (
        <div className="bg-white/[0.04] rounded-[20px] shadow-md shadow-black/20 border border-white/10 p-12 text-center">
      ...
      {filteredMissedTrades.length > 0 && (
        <div className="bg-white/[0.04] rounded-[20px] shadow-md shadow-black/20 border border-white/10 overflow-hidden transition-all duration-200 hover:shadow-[0_14px_40px_rgba(0,0,0,0.1)] hover:-translate-y-0.5">
                ...
                {filteredMissedTrades.map(trade => {
                  ...
                  return (
                    <tr key={trade.id} className="border-b border-white/5 hover:bg-white/[0.02] transition-colors duration-150">
                      ...
                      <td className="py-3.5 px-4 whitespace-nowrap">
                        <span className="inline-flex items-center px-2.5 py-1 rounded-full text-caption font-bold bg-white/5 text-foreground ring-1 ring-[#E5E7EB]">
                          {trade.pair}
                        </span>
                      </td>
                      <td className="py-3.5 px-4 whitespace-nowrap">
      ...
      {viewingTrade && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-in fade-in duration-200" onClick={() => setViewingTrade(null)}>
          <div className="bg-white/[0.04] rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col" onClick={(e) => e.stopPropagation()}>
            <div className="p-5 border-b border-white/10 bg-gradient-to-r from-violet-50/40 to-white flex-shrink-0">
      ...
      {viewingReason && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50" onClick={() => setViewingReason(null)}>
          <div className="bg-white/[0.04] rounded-2xl shadow-2xl max-w-lg w-full max-h-[80vh] overflow-hidden animate-in zoom-in-95 duration-200" onClick={(e) => e.stopPropagation()}>
            <div className="p-5 border-b border-white/10 bg-gradient-to-r from-violet-50 to-indigo-50/50">
