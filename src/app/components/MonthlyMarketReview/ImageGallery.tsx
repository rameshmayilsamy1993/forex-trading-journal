  ...
  if (images.length === 0) {
    return (
      ...
      >
        ...
        <p className="text-body font-medium text-muted-foreground">No images attached</p>
        <p className="text-caption text-muted-foreground mt-1">Screenshots will appear here</p>
      </motion.div>
    );
  }
